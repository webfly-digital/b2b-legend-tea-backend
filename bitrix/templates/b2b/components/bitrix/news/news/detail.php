...
<section>
    <div class="container-size-3">
        <div class="news-detail text-content">
            <a href="<?= $arResult["FOLDER"] . $arResult["URL_TEMPLATES"]["news"] ?>" class="icon-link mb-6">
...
$res = \CIblockElement::GetList([], ['ID' => $ElementID, 'IBLOCK_ID' => $arParams["IBLOCK_ID"]], false, false, ['PROPERTY_LINK_GOODS']);
while ($ar_fields = $res->GetNext()) {
    $linkGoods[] = $ar_fields["PROPERTY_LINK_GOODS_VALUE"];
}
global $USER;
if (!empty($linkGoods)) {
    global $goodsFilter;
    $goodsFilter = ['ID' => $linkGoods];
    ?>
    <section>
        <div class="container-size-3">
            <?
