                    ...
                    <div class="form-group">
                        <div class="form-col">
                            ...
                            <div class="form-row">
                                ...
                                $valueLogo = is_array($arResult["ORDER_PROPS_VALUES"]['ORDER_PROP_145']) && count($arResult["ORDER_PROPS_VALUES"]['ORDER_PROP_145']) == 1 ? current($arResult["ORDER_PROPS_VALUES"]['ORDER_PROP_145']) : $arResult["ORDER_PROPS_VALUES"]['ORDER_PROP_145'];
                            ...
                            <div class="form-row">
                                <div class="form-cell">
                                    ...
                                    <label class="dropzone">
                                        ...
                                        <div class="inner">
                                            <div class="placeholder <?= $valueLogo && $valueLogo['SRC'] ? 'hidden' : '' ?>">
                                                <div class="icon icon-plus"></div>
                                                <span>Добавить логотип</span>
                                            </div>
                                            <div class="img">
                                                <img src="<?= $valueLogo && $valueLogo['SRC'] ?$valueLogo['SRC'] : '' ?>"
                                                     alt="">
                                            </div>
                                        </div>
                                        <input type="text" name="FILE_REMOVE" value="" hidden>
                                        <input type="text" name="ORDER_PROP_145_del" value=""
                                               data-id-file="<?= $valueLogo && $valueLogo['ID'] ?$valueLogo['ID']: '' ?>"
                                               hidden>
                                    </label>
                                </div>
                                <div class="form-cell">
