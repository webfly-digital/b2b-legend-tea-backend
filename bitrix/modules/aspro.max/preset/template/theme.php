<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style type="text/css">
			...
			.wrap_header .inner_blocks{display:inline-block;vertical-align:middle;font-size:12px;width: auto !important;margin-bottom: 16px;}

			a.link_img_logo{display: inline-block;zoom: 1;vertical-align: middle;margin: 0;}
			a.link_img_logo img{display:block;}
			.phone_block{position:relative;text-align:right;padding-top:0px !important;font-size:0px;}
			.phone_block > div{display:inline-block;vertical-align:top;}
			.phone_block .phone_outer{border-radius: 100%;color: #000;background-color:%THEME_COLOR%;font-size: 16px;margin: 0px 5px 0;width: 35px;height: auto;text-align: center;height: 26px;padding-top: 9px;padding-bottom: 0px;display: inline-block;vertical-align: top;}
			.phone_block .phone_text{display: inline-block;vertical-align: top;}
			...
			div[data-bx-block-editor-block-type="component"] .bxBlockPadding .wrapper_block{padding:0px 0px !important;}
			.border_wrapper{margin-right:30px;margin-left:30px;}
			#bxStylistBody img.bxImage{margin-top:20px !important;}

			.scroll-x-block{overflow: scroll;-webkit-overflow-scrolling: touch;}
			

			/*products*/
			.products_block{padding-left: 30px !important;padding-right: 30px !important;}
			div[data-bx-block-editor-block-type="component"] .bxBlockPadding .products_block{padding-left: 0px !important;padding-right: 0px !important;}
			.products_block .item .inner-wrapper{overflow: hidden;}
			.sale_basket_small .item{white-space: nowrap;}
			.sale_basket_small .item .img + div{white-space: normal;}
			...
			@media (max-width: 600px) {
				.wrap_header .inner_blocks{display: block;}
				.wrap_header .inner_blocks:last-of-type{margin-top: 15px;}
				.phone .bxBlockContentText .phone_block{text-align: left !important;}
				.phone .bxBlockContentText .phone_block br{display: none;}
																			...
																			<tbody>
																				<tr>
																					<td valign="top" class="bxBlockPadding">
																						<table align="left" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate !important; margin: 0px 5px 10px;height: 25px;">
																							<tbody>
																								<tr>
