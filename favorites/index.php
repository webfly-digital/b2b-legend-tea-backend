...
<div class="container-size-3">
    <div class="favourites-page">
        ...
        <? $favs = $APPLICATION->includeComponent('webfly:b2b.favorites', '', []); ?>
        <? if ($favs): ?>
            <div class="note-plate">Это список ваших желаемых покупок. Из него вы можете также добавить товары в корзину.</div>
            <?
            global $favFilter;
            $favFilter = ['ID' => $favs];
            ...
            $filter = array_merge($favFilter, $baseFilter);
        ...
        <? else: ?>
            <div class="note-plate">В списке желаемых покупок нет товаров.</div>
        <? endif ?>
    </div>
</div>
